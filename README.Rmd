...
We provide a bash script to aid users to install all the dependencies. The script uses Wget, which is pre-installed on most Linux distributions today such as Windows Subsystem for Linux, to download some of the utilities. If wget is not installed, users can easily install it with the following commands. 
...
With Wget installed, users can install all the dependencies in the working directory with the following commands:
``` r
