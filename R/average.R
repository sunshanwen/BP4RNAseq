...
average <- function()
{
  ...
  write.csv(ave_gene, "average_gene_quantification.csv", row.names=FALSE)
  ...
  write.csv(align_based_transcript, "transcript_alignment_based_quantification.csv", row.names=FALSE)
  write.csv(align_free_transcript, "transcript_alignment_free_quantification.csv", row.names=FALSE)
  ...
  write.csv(ave_transcript, "average_transcript_quantification.csv", row.names=FALSE)
}
